...
public class AdditionalDetailsAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7071301322185071630L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AdditionalDetailsAvro\",\"namespace\":\"com.dbs.clconnbc.api.model\",\"fields\":[{\"name\":\"nationality\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"gender\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"dateOfBirth\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"identificationNumber\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"countryOfIncorporation\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"dateOfIncorporation\",\"type\":[\"null\",\"string\"],\"default\":null}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<AdditionalDetailsAvro> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<AdditionalDetailsAvro> DECODER =
   ...
   */
  public static BinaryMessageEncoder<AdditionalDetailsAvro> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<AdditionalDetailsAvro> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<AdditionalDetailsAvro> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this AdditionalDetailsAvro to a ByteBuffer.
  ...
  /**
   * Deserializes a AdditionalDetailsAvro from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a AdditionalDetailsAvro instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static AdditionalDetailsAvro fromByteBuffer(
   ...
   */
  public AdditionalDetailsAvro(CharSequence nationality, CharSequence gender, CharSequence dateOfBirth, CharSequence identificationNumber, CharSequence countryOfIncorporation, CharSequence dateOfIncorporation) {
  ...
  public Object get(int field$) {
    switch (field$) {
    case 0: return nationality;
    case 1: return gender;
    case 2: return dateOfBirth;
    case 3: return identificationNumber;
    case 4: return countryOfIncorporation;
    case 5: return dateOfIncorporation;
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: nationality = (CharSequence)value$; break;
    case 1: gender = (CharSequence)value$; break;
    case 2: dateOfBirth = (CharSequence)value$; break;
    case 3: identificationNumber = (CharSequence)value$; break;
    case 4: countryOfIncorporation = (CharSequence)value$; break;
    case 5: dateOfIncorporation = (CharSequence)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
  ...
  /**
   * Creates a new AdditionalDetailsAvro RecordBuilder.
   * @return A new AdditionalDetailsAvro RecordBuilder
   */
  ...
  /**
   * Creates a new AdditionalDetailsAvro RecordBuilder by copying an existing Builder.
  ...
  /**
   * Creates a new AdditionalDetailsAvro RecordBuilder by copying an existing AdditionalDetailsAvro instance.
   * @param other The existing instance to copy.
   * @return A new AdditionalDetailsAvro RecordBuilder
   */
  public static Builder newBuilder(AdditionalDetailsAvro other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  /**
   * RecordBuilder for AdditionalDetailsAvro instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AdditionalDetailsAvro>
    implements org.apache.avro.data.RecordBuilder<AdditionalDetailsAvro> {
    ...
    /**
     * Creates a Builder by copying an existing AdditionalDetailsAvro instance
     * @param other The existing instance to copy.
     */
    private Builder(AdditionalDetailsAvro other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.nationality)) {
        this.nationality = data().deepCopy(fields()[0].schema(), other.nationality);
    ...
    public AdditionalDetailsAvro build() {
      try {
        AdditionalDetailsAvro record = new AdditionalDetailsAvro();
        ...
        record.identificationNumber = fieldSetFlags()[3] ? this.identificationNumber : (CharSequence) defaultValue(fields()[3]);
        record.countryOfIncorporation = fieldSetFlags()[4] ? this.countryOfIncorporation : (CharSequence) defaultValue(fields()[4]);
        record.dateOfIncorporation = fieldSetFlags()[5] ? this.dateOfIncorporation : (CharSequence) defaultValue(fields()[5]);
        return record;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<AdditionalDetailsAvro>
    WRITER$ = (org.apache.avro.io.DatumWriter<AdditionalDetailsAvro>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<AdditionalDetailsAvro>
    READER$ = (org.apache.avro.io.DatumReader<AdditionalDetailsAvro>)MODEL$.createDatumReader(SCHEMA$);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 1) {
        ...
        this.identificationNumber = in.readString(this.identificationNumber instanceof Utf8 ? (Utf8)this.identificationNumber : null);
      }
      ...
      if (in.readIndex() != 1) {
        ...
        this.countryOfIncorporation = in.readString(this.countryOfIncorporation instanceof Utf8 ? (Utf8)this.countryOfIncorporation : null);
      }
      ...
      if (in.readIndex() != 1) {
        ...
        this.dateOfIncorporation = in.readString(this.dateOfIncorporation instanceof Utf8 ? (Utf8)this.dateOfIncorporation : null);
      }
