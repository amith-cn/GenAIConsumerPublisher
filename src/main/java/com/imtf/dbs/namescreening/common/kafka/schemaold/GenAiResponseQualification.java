package com.imtf.dbs.namescreening.common.kafka.schemaold;
/**
...
public class GenAiResponseQualification extends org.apache.avro.specific.SpecificRecordBase
    ...
    private static final BinaryMessageEncoder<GenAiResponseQualification> ENCODER =
            new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

    private static final BinaryMessageDecoder<GenAiResponseQualification> DECODER =
     ...
     */
    public static BinaryMessageEncoder<GenAiResponseQualification> getEncoder() {
        return ENCODER;
    }
     ...
     */
    public static BinaryMessageDecoder<GenAiResponseQualification> getDecoder() {
        return DECODER;
    }
     ...
     */
    public static BinaryMessageDecoder<GenAiResponseQualification> createDecoder(SchemaStore resolver) {
        return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
    }

    /**
     * Serializes this GenAiResponseQualification to a ByteBuffer.
    ...
    /**
     * Deserializes a GenAiResponseQualification from a ByteBuffer.
     * @param b a byte buffer holding serialized data for an instance of this class
     * @return a GenAiResponseQualification instance decoded from the given buffer
     * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
     */
    public static GenAiResponseQualification fromByteBuffer(java.nio.ByteBuffer b) throws java.io.IOException {
     ...
     */
    public GenAiResponseQualification() {}
     ...
     */
    public GenAiResponseQualification(
            CharSequence hitRelevancy,
            CharSequence identification,
            CharSequence hitJustification,
            CharSequence materiality,
            java.util.List<CharSequence> reason,
            CharSequence otherReason,
            CharSequence justification) {
    ...
    public void put(int field$, Object value$) {
        switch (field$) {
            case 0:
                hitRelevancy = (CharSequence) value$;
                break;
            case 1:
                identification = (CharSequence) value$;
                break;
            case 2:
                hitJustification = (CharSequence) value$;
                break;
            case 3:
                materiality = (CharSequence) value$;
                break;
            case 4:
                reason = (java.util.List<CharSequence>) value$;
                break;
            case 5:
                otherReason = (CharSequence) value$;
                break;
            case 6:
                justification = (CharSequence) value$;
                break;
            default:
                throw new IndexOutOfBoundsException("Invalid index: " + field$);
        }
     ...
     * @param value the value to set.
     */
    public void setReason(List<CharSequence> value) {
        this.reason = value;
    }
    ...
    /**
     * Creates a new GenAiResponseQualification RecordBuilder.
     * @return A new GenAiResponseQualification RecordBuilder
     */
    ...
    /**
     * Creates a new GenAiResponseQualification RecordBuilder by copying an existing Builder.
    ...
    /**
     * Creates a new GenAiResponseQualification RecordBuilder by copying an existing GenAiResponseQualification instance.
     * @param other The existing instance to copy.
     * @return A new GenAiResponseQualification RecordBuilder
     */
    public static Builder newBuilder(GenAiResponseQualification other) {
        if (other == null) {
            return new Builder();
        } else {
            return new Builder(other);
    ...
    /**
     * RecordBuilder for GenAiResponseQualification instances.
     */
    @org.apache.avro.specific.AvroGenerated
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GenAiResponseQualification>
            implements org.apache.avro.data.RecordBuilder<GenAiResponseQualification> {
        ...
        /**
         * Creates a Builder by copying an existing GenAiResponseQualification instance
         * @param other The existing instance to copy.
         */
        private Builder(GenAiResponseQualification other) {
            super(SCHEMA$, MODEL$);
            if (isValidValue(fields()[0], other.hitRelevancy)) {
                this.hitRelevancy = data().deepCopy(fields()[0].schema(), other.hitRelevancy);
        ...
        public GenAiResponseQualification build() {
            try {
                GenAiResponseQualification record = new GenAiResponseQualification();
                record.hitRelevancy = fieldSetFlags()[0] ? this.hitRelevancy : (CharSequence) defaultValue(fields()[0]);
                record.identification =
                        fieldSetFlags()[1] ? this.identification : (CharSequence) defaultValue(fields()[1]);
                record.hitJustification =
                        fieldSetFlags()[2] ? this.hitJustification : (CharSequence) defaultValue(fields()[2]);
                record.materiality = fieldSetFlags()[3] ? this.materiality : (CharSequence) defaultValue(fields()[3]);
                record.reason =
                        fieldSetFlags()[4] ? this.reason : (java.util.List<CharSequence>) defaultValue(fields()[4]);
                record.otherReason = fieldSetFlags()[5] ? this.otherReason : (CharSequence) defaultValue(fields()[5]);
                record.justification =
                        fieldSetFlags()[6] ? this.justification : (CharSequence) defaultValue(fields()[6]);
                return record;
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumWriter<GenAiResponseQualification> WRITER$ =
            (org.apache.avro.io.DatumWriter<GenAiResponseQualification>) MODEL$.createDatumWriter(SCHEMA$);
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumReader<GenAiResponseQualification> READER$ =
            (org.apache.avro.io.DatumReader<GenAiResponseQualification>) MODEL$.createDatumReader(SCHEMA$);
    ...
    public void customDecode(org.apache.avro.io.ResolvingDecoder in) throws java.io.IOException {
        ...
        if (fieldOrder == null) {
            ...
            if (in.readIndex() != 1) {
                ...
                this.identification =
                        in.readString(this.identification instanceof Utf8 ? (Utf8) this.identification : null);
            }

            if (in.readIndex() != 1) {
                in.readNull();
                this.hitJustification = null;
            } else {
                this.hitJustification =
                        in.readString(this.hitJustification instanceof Utf8 ? (Utf8) this.hitJustification : null);
            }
            ...
            if (in.readIndex() != 1) {
                ...
                if (a0 == null) {
                    a0 = new SpecificData.Array<CharSequence>(
                            (int) size0,
                            SCHEMA$.getField("reason").schema().getTypes().get(1));
                    this.reason = a0;
                } else a0.clear();
                SpecificData.Array<CharSequence> ga0 =
                        (a0 instanceof SpecificData.Array ? (SpecificData.Array<CharSequence>) a0 : null);
            ...
            if (in.readIndex() != 1) {
                ...
                this.justification =
                        in.readString(this.justification instanceof Utf8 ? (Utf8) this.justification : null);
            }
                ...
                switch (fieldOrder[i].pos()) {
                    case 0:
                        if (in.readIndex() != 1) {
                            ...
                            this.hitRelevancy =
                                    in.readString(this.hitRelevancy instanceof Utf8 ? (Utf8) this.hitRelevancy : null);
                        }
                        break;
                    ...
                    case 1:
                        if (in.readIndex() != 1) {
                            ...
                            this.identification = in.readString(
                                    this.identification instanceof Utf8 ? (Utf8) this.identification : null);
                        }
                        break;
                    ...
                    case 2:
                        if (in.readIndex() != 1) {
                            ...
                            this.hitJustification = in.readString(
                                    this.hitJustification instanceof Utf8 ? (Utf8) this.hitJustification : null);
                        }
                        break;
                    ...
                    case 3:
                        if (in.readIndex() != 1) {
                            ...
                            this.materiality =
                                    in.readString(this.materiality instanceof Utf8 ? (Utf8) this.materiality : null);
                        }
                        break;
                    ...
                    case 5:
                        if (in.readIndex() != 1) {
                            ...
                            this.otherReason =
                                    in.readString(this.otherReason instanceof Utf8 ? (Utf8) this.otherReason : null);
                        }
                        break;
                    ...
                    case 6:
                        if (in.readIndex() != 1) {
                            ...
                            this.justification = in.readString(
                                    this.justification instanceof Utf8 ? (Utf8) this.justification : null);
                        }
                        break;
