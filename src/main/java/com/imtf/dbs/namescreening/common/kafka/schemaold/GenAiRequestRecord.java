...
public class GenAiRequestRecord extends org.apache.avro.specific.SpecificRecordBase
    ...
    private static final BinaryMessageEncoder<GenAiRequestRecord> ENCODER = new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

    private static final BinaryMessageDecoder<GenAiRequestRecord> DECODER = new BinaryMessageDecoder<>(MODEL$, SCHEMA$);
     ...
     */
    public static GenAiRequestRecord fromByteBuffer(java.nio.ByteBuffer b) throws java.io.IOException {
    ...
    public GenAiRequestRecord(
            ...
            CharSequence screenedName,
            CharSequence type,
            CharSequence hitId,
            CharSequence hitUrl,
            CharSequence rmLocation,
            CharSequence bookingCentre,
            GenAiRequestAdditionalDetails additionalDetails) {
        this.caseId = caseId;
    ...
    public void put(int field$, Object value$) {
        switch (field$) {
            ...
            case 3:
                ...
                break;
            case 4:
                screenedName = (CharSequence) value$;
                break;
            case 5:
            ...
            case 9:
                ...
                break;
            case 10:
                additionalDetails = (GenAiRequestAdditionalDetails) value$;
                break;
            default:
                throw new IndexOutOfBoundsException("Invalid index: " + field$);
        }
        ...
        private Builder(Builder other) {
            ...
            if (other.hasAdditionalDetailsBuilder()) {
                this.additionalDetailsBuilder =
                        GenAiRequestAdditionalDetails.newBuilder(other.getAdditionalDetailsBuilder());
            }
        }
        ...
        public GenAiRequestRecord build() {
            try {
                ...
                record.bookingCentre =
                        fieldSetFlags()[9] ? this.bookingCentre : (CharSequence) defaultValue(fields()[9]);
                if (additionalDetailsBuilder != null) {
                    try {
                    ...
                    record.additionalDetails = fieldSetFlags()[10]
                            ? this.additionalDetails
                            : (GenAiRequestAdditionalDetails) defaultValue(fields()[10]);
                }
                return record;
            } catch (org.apache.avro.AvroMissingFieldException e) {
                throw e;
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumWriter<GenAiRequestRecord> WRITER$ =
            (org.apache.avro.io.DatumWriter<GenAiRequestRecord>) MODEL$.createDatumWriter(SCHEMA$);
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumReader<GenAiRequestRecord> READER$ =
            (org.apache.avro.io.DatumReader<GenAiRequestRecord>) MODEL$.createDatumReader(SCHEMA$);
                ...
                switch (fieldOrder[i].pos()) {
                    ...
                    case 4:
                        if (in.readIndex() != 1) {
                            ...
                            this.screenedName =
                                    in.readString(this.screenedName instanceof Utf8 ? (Utf8) this.screenedName : null);
                        }
                        break;
